...
class PcCatAdapter2(private val homeFrag: Home) : RecyclerView.Adapter<PcCatAdapter2.myViewHolder>()
{
    private val adsList = ArrayList<Ad>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): myViewHolder {

        return myViewHolder(CatergoryAdCard2Binding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
    ...
    override fun onBindViewHolder(holder: myViewHolder, position: Int) {
        ...
        homeFrag.contentLoaded()
    }
    inner class myViewHolder( val binding: CatergoryAdCard2Binding) :
        RecyclerView.ViewHolder(binding.root) {
        fun bindData(adPrice: String, adTitle: String, adLocation: String, adTime: String,
                     adDescription:String, adImagesList: ArrayList<String>, adCategory: String, adUploader:String) {
