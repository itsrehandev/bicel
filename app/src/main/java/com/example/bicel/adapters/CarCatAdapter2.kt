...
class CarCatAdapter2(private val homeFrag: Home) : RecyclerView.Adapter<CarCatAdapter2.myViewHolder>() {
    ...
    inner class myViewHolder(val binding: CatergoryAdCard2Binding) :
        ...
        fun bindData(adPrice: String, adTitle: String, adLocation: String, adTime: String,
                     adDescription:String, adImagesList: ArrayList<String>, adCategory: String,
                     adUploader: String
        ) {
